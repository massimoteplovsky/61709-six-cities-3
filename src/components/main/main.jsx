...
import {getOffersByCity, getAllOffers, getActualCity} from "../../selectors/offers.js";
        ...
        <div className="cities">
          <div className="cities__places-container container">
            <section className="cities__places places">
              ...
              <b className="places__found">{filteredOffers.length} places to stay in {actualCity}</b>
